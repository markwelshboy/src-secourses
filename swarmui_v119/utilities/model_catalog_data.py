...
# New Qwen Image 2512 model entries
qwen_image_2512_quant_fp8_scaled_entry = {
    "name": "Qwen_Image_2512_Quant_FP8_Scaled.safetensors",
    "repo_id": "MonsterMMORPG/Wan_GGUF",
    "filename_in_repo": "Qwen_Image_2512_Quant_FP8_Scaled.safetensors",
    "save_filename": "Qwen_Image_2512_Quant_FP8_Scaled.safetensors",
    "target_dir_key": "diffusion_models",
}

qwen_image_2512_bf16_entry = {
    "name": "Qwen_Image_2512_BF16.safetensors",
    "repo_id": "MonsterMMORPG/Wan_GGUF",
    "filename_in_repo": "Qwen_Image_2512_BF16.safetensors",
    "save_filename": "Qwen_Image_2512_BF16.safetensors",
    "target_dir_key": "diffusion_models",
}
...
# New Qwen Image 2512 Turbo LoRA 4steps model entry
qwen_image_2512_turbo_lora_4steps_v1_entry = {
    "name": "Wuli-Qwen-Image-2512-Turbo-LoRA-4steps-V1.safetensors",
    "repo_id": "MonsterMMORPG/Wan_GGUF",
    "filename_in_repo": "Wuli-Qwen-Image-2512-Turbo-LoRA-4steps-V1.safetensors",
    "save_filename": "Wuli-Qwen-Image-2512-Turbo-LoRA-4steps-V1.safetensors",
    "target_dir_key": "Lora",
    "info": "Wuli Qwen Image 2512 Turbo LoRA for fast 4-step image generation. Saves to Lora folder. Use with Qwen Image models.",
}
        ...
        "bundles": [
            {
                ...
                "models_to_download": [
                    ...
                    ("Image Generation Models", "Qwen Image Models", "Wuli-Qwen-Image-2512-Turbo-LoRA-4steps-V1.safetensors"),
                    ("Image Generation Models", "Qwen Image Models", "Qwen_Image_2512_Quant_FP8_Scaled.safetensors"),
