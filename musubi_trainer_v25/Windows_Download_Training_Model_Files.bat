...
echo.
echo 2. Qwen Image Edit Plus ^(2509^) Training Models
echo    - qwen_2.5_vl_7b_bf16.safetensors
echo    - qwen_train_vae.safetensors
echo    - Qwen_Image_Edit_Plus_2509_bf16.safetensors
echo    Default directory: Training_Models_Qwen
echo.
echo 3. Qwen Image Edit ^(2511^) Training Models
echo    - qwen_2.5_vl_7b_bf16.safetensors
echo    - qwen_train_vae.safetensors
echo    - Qwen_Image_Edit_2511_BF16.safetensors
echo    Default directory: Training_Models_Qwen
echo.
echo 4. Wan 2.1 Text to Video Training Models
...
echo.
echo 5. Wan 2.2 Text to Video Training Models
echo    - Wan2_1_VAE_bf16.safetensors
echo    - umt5-xxl-enc-bf16.safetensors
...
echo    Default directory: Training_Models_Wan
echo.
echo 6. Wan 2.2 Image to Video Training Models
echo    - Wan2_1_VAE_bf16.safetensors
echo    - umt5-xxl-enc-bf16.safetensors
...
if "%choice%"=="1" (
    ...
    echo.
    echo Invalid choice. Please run the script again and select 1, 2, 3, 4, 5, or 6.
    pause
    exit /b 1
)
