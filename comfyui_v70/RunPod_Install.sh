...
print_color "$CYAN" "========================================================"
print_color "$CYAN" "SwarmUI ExtraNodes Installation"
print_color "$CYAN" "========================================================"
print_color "$NC" ""
...
if [ -d "SwarmComfyCommon" ]; then
    print_color "$YELLOW" "Removing existing SwarmComfyCommon..."
    rm -rf SwarmComfyCommon
fi

# Remove existing SwarmKSampler if it exists
if [ -d "SwarmKSampler" ]; then
    print_color "$YELLOW" "Removing existing SwarmKSampler..."
    rm -rf SwarmKSampler
fi

print_color "$CYAN" "Downloading SwarmUI ExtraNodes (SwarmComfyCommon and SwarmKSampler)..."
...
print_color "$YELLOW" "Downloading SwarmComfyCommon..."
...
print_color "$YELLOW" "Downloading SwarmComfyExtra..."
...
print_color "$YELLOW" "Downloading SwarmKSampler..."
...
print_color "$GREEN" "SwarmUI ExtraNodes installed successfully!"
print_color "$NC" ""
print_color "$CYAN" "Installed nodes:"
print_color "$GREEN" "  - SwarmComfyCommon"
print_color "$GREEN" "  - SwarmKSampler"
print_color "$NC" ""
